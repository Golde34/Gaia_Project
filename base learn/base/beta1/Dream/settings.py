...
ROOT_LOG_CONF = {
    ...
    'handlers':{
        'file':{
            ...
            'level': 'DEBUG',
            'formatter': 'detailed',
            'filename': 'D:\\Code\\PersonalProject\\Golde_AI_Assistant_System\\base learn\\base\\beta1\\Dream\\dream.log',
            'mode': 'a',
            'maxBytes': 10000000,
            'backupCount': 3,
        },
...
GMAIL_SETTINGS = {
    'account':'nguyendongducviet2001@gmail.com',
    'password':'Gegterss03042001@',
    'sleep_time':60
}
