...
from utils.console import warning, error, executable_exists
...
class PluginManager(object):
    ...
    def __init__(self):
        ...
        self._backend.add_blacklisted_directories("gaia_bot/packages/aiml")
        self._backend.add_blacklisted_directories("gaia_bot/packages/memory")
