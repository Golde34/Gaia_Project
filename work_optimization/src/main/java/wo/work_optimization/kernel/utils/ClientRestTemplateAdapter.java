...
//         log.info(RESPONSE, httpStatus.value(), responseEntity.getStatusCode().getReasonPhrase(), responseEntity.getBody());
...
//         HttpStatus httpStatus = responseEntityParameterized.getStatusCode();
//         log.info(RESPONSE, httpStatus.value(), responseEntityParameterized.getStatusCode().getReasonPhrase(), responseEntityParameterized.getBody());
