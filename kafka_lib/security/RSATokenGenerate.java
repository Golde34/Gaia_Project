...
public class RSATokenGenerate {
    public static void main(String[] args) throws Exception {
        ...
        byte[] decryptedBytes = decryptCipher.doFinal(Base64.getDecoder().decode("AYuyWYT7IK3i/cgm5tmb+CYegScR0GFxHr1MNY3nSvEXfpBZfGnIBPOYnBnKxmihLpDDosGx5bpg6M01OSp0IkjDQaPnBAZBoYgv+TjjYKoabbMk9RsU+h7O2lhOxaPB/mjifUROD947faxX89tj/y57Qa9cIQzfyKelPCWdkPk="));
