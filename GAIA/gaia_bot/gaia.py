...
from core.cmd_interpreter import CmdInterpreter
...
class Gaia(CmdInterpreter, object):
    ...
    def __init__(self, first_reaction_text=first_reaction_text,
                 ...
                 directories=["gaia_bot/skills/plugins", "custom"]):
    ...
    def default(self, data):
        ...
        self.say("I could not identify your command...", color=Fore.RED, speak=True)
        # console_output("I could not identify your command...", self, Fore.RED)
