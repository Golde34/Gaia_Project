...
class EntityModel(nn.Module):
    def __init__(self, num_tag, num_pos):
        ...
        self.bert = transformers.BertModel.from_pretrained(model_config.BASE_MODEL_PATH, return_dict=False)
    ...
    def forward(self, ids, mask, token_type_ids, target_pos, target_tag):
        ...
        loss_tag = loss_calculate(tag, target_tag, mask, self.num_tag)
        loss_pos = loss_calculate(pos, target_pos, mask, self.num_pos)
